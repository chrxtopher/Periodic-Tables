...
function TablesList({ tables, reservations }) {
  ...
  return tables.map((table) => {
    ...
    const status = reservation ? <strong>Occupied by: {reservation.first_name} {reservation.last_name}</strong> : "Free"

    return (
        <div key={table.table_id} className="card bg-light border-dark m-4 shadow">
